...
if __name__ == '__main__':
    ...
    #如果要运行自己训练的yolov5模型，需要修改这里的识别物体类型名字文件和模型名字
    #识别物体类型名字文件和模型文件对应关系：fall_detect.onnx--status.names;number_detect.onnx--number.names;yolov5s.onnx--coco.names
    # Load category labels
    with open('number.names', 'rt') as f:
